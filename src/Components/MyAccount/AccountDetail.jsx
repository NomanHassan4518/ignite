...
const AccountDetail = () => {
  ...
  //   queryKey:["Account"],
  //   queryFn:()=>{
  //     axios.get("https://pos-dev.myignite.online/connector/api/contactapi" , {
  //       method:"GET",
  //       headers:{
...
<div className='col-span-8 mt-6 mx-3'>
  ...
  <button className='bg-green-900 text-white font-bold py-3 w-24 rounded-md' onClick={updateFormValue}>Update</button>
</div>
