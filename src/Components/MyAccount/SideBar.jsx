...
const SideBar = () => {
    ...
    const logout = () => {
        axios.get("https://pos-dev.myignite.online/connector/api/abandonedcart/delete/null", {
            headers: {
    ...
    return (
        <div>
            <aside className="lg:absolute lg:w-96  " >
                <div className="h-full lg:px-3 py-4 overflow-y-auto ">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <button to="/logout" className="flex items-center p-2 w-full text-start text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" onClick={logout}>
