...
const ProductDetail = () => {
    ...
    let product_detail = location.state.modelData.modelData
            ...
            <div className="lg:grid lg:grid-cols-9 gap-x-5 mx-6 mt-10">
                <div className='col-span-5'>
                    <div className='block'>
                        ...
                        >
                            <div className='flex items-center justify-center w-80 h-72'>
                                <img src={product_detail.image.original} alt="" />
                            </div>
                            <div className='flex items-center justify-center w-80 h-56'>
                                <img src={product_detail?.gallery[ind]?.original} alt='' />
                            </div>
                ...
                <div className='col-span-4'>
                    <h3 className='text-2xl font-bold mb-6'>{product_detail?.name}</h3>
                    <p className='text-base text-gray-500 leading-8'>{product_detail?.description}</p>
                    <h3 className='text-2xl font-bold mt-6 mb-5'>{product_detail?.price}</h3>
                    <hr className='mt-9' />
