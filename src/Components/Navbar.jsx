            ...
            >
                ...
                <div>
                  <div>
                    ...
                    <p className='text-2xl font-bold'>{myData.title}</p>
                  </div>
                </div>
                    <button className='w-full flex flex-col pt-2 pb-2'>
                        <a href='/' className='w-full bg-[#999999] text-white hover:text-white rounded-md cursor-not-allowed px-2 py-3 flex items-center justify-center hover:bg-gray-900'>
                            ...
                            <span className='mx-auto md:text-[17px] font-semibold'>|   SAR 0.00</span>
                        </a>
                    </button>
                </div>
            </Drawer>
