        ...
        <>
                        ...
                        <div className='flex space-x-7 z-50 items-center justify-center' >
                            ...
                            <div>
                                ...
                                <button type="button" className="relative inline-flex items-center p-3 text-sm font-medium text-center text-black  focus:outline-none focus:ring-0 dark:bg-none  dark:focus:ring-0" onClick={drawweOpen}>
                                    ...
                                    <div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-black border-2 border-white rounded-full -top-[0.1rem] -right-[0.2rem] dark:border-gray-900" >{myData.length}</div>
                                </button>
            ...
            >
                <div >
                    ...
                    <div className={myData.length !== 0 ? "block" : "hidden"}>

                        <div className='flex  justify-between items-center'>
                            <div className='group cursor-pointer'>
                                <img src={myData[0]?.Product.url} alt="" className='w-[160px] h-28' />
                                <div className='hidden bg-[#0000004a]  text-white w-[160px] rounded top-20 absolute group-hover:flex justify-center items-center h-[150px]'>
                                    <AiOutlineClose className='text-[40px]' onClick={remove} />
                                </div>
                            </div>

                            <div className='ml-2'>
                                <p className='h-[20px] overflow-hidden'>{myData[0]?.Product.title} </p>
                                <p className='mt-1 text-gray-400'>Unit Price: {myData[0]?.Product.price}</p>

                                <div className="flex bg-black text-white font-bold text-lg mt-5 h-10 rounded-md">
                                    <button className='flex justify-center items-center w-9 lg:w-12 border-e border-gray-400 cursor-pointer' onClick={sub} disabled={quantity === 1}>-</button>
                                    <button className='w-20'> {quantity}</button>
                    ...
                    <button className='flex  absolute bottom-2  flex-col pt-2 pb-2'>
                        <div className='w-full bg-[#000] text-white hover:text-white rounded-md cursor-not-allowed px-2 py-3 flex items-center justify-center '>
                            ...
                            <span className='mx-auto md:text-[17px] font-semibold '>| {myData.length !== 0 ? myData[0]?.Product.price : "SAR 0.00"}</span>
                        </div>
                    </button>
                </div>
            </Drawer>
