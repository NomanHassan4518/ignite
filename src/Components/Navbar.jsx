        ...
        <>
            ...
            >
                <div >
                    ...
                    <div>
                        <div className={cardProduct?.length !== 0 ? "block h-[44rem] " : "hidden"}>
                                        ...
                                        <div className='ml-4'>
                                            ...
                                            <div className="flex justify-between w-full items-center mt-5">
                                                <div className="flex bg-black text-white font-bold text-lg  h-10 rounded-md">
                                                    <button className='flex justify-center items-center w-9 lg:w-10 border-e border-gray-400 cursor-pointer' onClick={() => { sub(index) }}>-</button>
                                                    <button className='w-12'> {items.quatity}</button>
                                                    <button className='flex justify-center items-center w-9 lg:w-10 border-s border-gray-400 cursor-pointer' onClick={() => { add(index) }}>+</button>
                                                </div>
                        ...
                        <div className='absolute bottom-0 w-full flex items-center justify-center h-24 bg-white'>

                            <button className='flex  pt-2 mb-5 ' onClick={CheckOut}>
                                <div className={` w-96 bg-[#000] text-white hover:text-white ${cardProduct?.length !== 0 ? "cursor-pointer" : 'cursor-not-allowed '} rounded-md px-2 py-4 flex items-center justify-center`} onClick={close}>
